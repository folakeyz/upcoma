...
import { CommentsCard, Player, DJJumbotron } from "../../../components";
...
const SingleDJ = () => {
  ...
  const { mutate: post, reset, isSuccess } = hooks.usePostMixComment();
  const submitHandler = () => {
    if (!formData["rating"])
